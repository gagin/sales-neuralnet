...
```
90% for a single neuron? Interesting.

OK, back to 5 neurons.  
Let's check - perhaps rating matters after all?  
Let's wipe it out of the test set and see.
...
92% make some sense - supposedly low price would indeed result in better
sales.  
