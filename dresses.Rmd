...
# select() above needed direct reference to dplyr library because libraries
...
Hmm... Nnet() couldn't handle it, says "too many (4621) weights".
I've commented out
...
Still doesn't work. What's wrong? It seems to have worked before. Let's try
...
OK, let's try to use neuralnet() library now, hoping that it will allow for
...
- See if "too many weights" can be solved for nnet (and how it worked before for
me)
