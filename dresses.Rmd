...
OK, it doesn't work. Some different approach is needed, obviously.
let's try to use neuralnet() library now, hoping that it will allow for
...
# - Make nnet() call a function and auto-calculate MaxNWts
```